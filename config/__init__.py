...
class Settings(BaseSettings):
    ...
    DB_UNIX_SOCKET: Optional[str] = os.getenv('DB_UNIX_SOCKET')
    DB_SSL_MODE: Optional[str] = os.getenv('DB_SSL_MODE')
    ...
    # JWT Configuration
    JWT_SECRET: str = os.getenv('JWT_SECRET', 'your-jwt-secret-key-here-change-in-production')
    ...
    # CORS Configuration
    BACKEND_CORS_ORIGINS: List[str] = json.loads(os.getenv('BACKEND_CORS_ORIGINS', '["http://localhost:3000","http://localhost:8000"]'))
    ...
    CELERY_TASK_SOFT_TIME_LIMIT: int = int(os.getenv('CELERY_TASK_SOFT_TIME_LIMIT', '1200'))
    ...
    PUSHER_APP_ID: Optional[str] = os.getenv('PUSHER_APP_ID')
    PUSHER_APP_KEY: Optional[str] = os.getenv('PUSHER_APP_KEY')
    PUSHER_APP_SECRET: Optional[str] = os.getenv('PUSHER_APP_SECRET')
    PUSHER_APP_CLUSTER: str = os.getenv('PUSHER_APP_CLUSTER', 'mt1')
    PUSHER_HOST: Optional[str] = os.getenv('PUSHER_HOST')
    ...
    ABLY_KEY: Optional[str] = os.getenv('ABLY_KEY')
