...
class Storage:
    ...
    def __init__(self, disk: Optional[str] = None):
        """
        ...
        self._filesystem: Optional[FS] = None
    ...
    def _create_s3_filesystem(self, config: dict) -> FS:
        ...
        try:
            ...
            raise ImportError("fs-s3fs is required for S3 storage. Install it with: pip install fs-s3fs")
    ...
    def put(self, path: str, content: Union[str, bytes, BinaryIO], overwrite: bool = True) -> bool:
        """
    ...
    def url(self, path: str) -> Optional[str]:
        """
        Get URL for file.
...
def get_storage(disk: Optional[str] = None) -> Storage:
...
def storage(disk: Optional[str] = None) -> Storage:
    """
