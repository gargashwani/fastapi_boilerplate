...
import os
from app.console.templates.service import SERVICE_TEMPLATE, SERVICE_WITH_INTERFACE_TEMPLATE
from app.console.templates.controller import BASIC_CONTROLLER_TEMPLATE, RESOURCE_CONTROLLER_TEMPLATE, API_CONTROLLER_TEMPLATE
